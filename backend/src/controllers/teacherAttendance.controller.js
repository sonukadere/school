...
export const listTeacherAttendances = asyncHandler(async (req, res) => {
  const result = await teacherAttendanceService.listTeacherAttendances(req.query, req.user);
  res
    .status(200)
...
export const getTeacherAttendance = asyncHandler(async (req, res) => {
  const attendance = await teacherAttendanceService.getTeacherAttendance(req.params.id, req.user);
...
export const markTeacherAttendance = asyncHandler(async (req, res) => {
  const attendance = await teacherAttendanceService.markTeacherAttendance(req.body, req.user);
...
export const bulkMarkTeacherAttendance = asyncHandler(async (req, res) => {
  const results = await teacherAttendanceService.bulkMarkTeacherAttendance(req.body, req.user);
  res
    .status(201)
...
export const updateTeacherAttendance = asyncHandler(async (req, res) => {
  const attendance = await teacherAttendanceService.updateTeacherAttendance(req.params.id, req.body, req.user);
...
export const deleteTeacherAttendance = asyncHandler(async (req, res) => {
  await teacherAttendanceService.deleteTeacherAttendance(req.params.id, req.user);
