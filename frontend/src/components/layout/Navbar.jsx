...
const QUICK_ACTIONS = [
  ...
  { label: 'Generate Marksheet', to: '/marks/generate', icon: Award, color: 'text-amber-600 bg-amber-50' },
  ...
  { label: 'Pay Fees', to: '/fees?record=true', icon: Wallet, color: 'text-rose-600 bg-rose-50' },
