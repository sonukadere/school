  ...
  return (
    <div>
      <PageHeader
        ...
        description="Official school admission registry entry (प्रवेश फार्म) & student portal login setup"
        showBack={false}
        breadcrumb={[
      ...
      {createdResult && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-fade-in">
          <div className="w-full max-w-md rounded-3xl bg-white p-4 sm:p-7 shadow-2xl border border-slate-100 text-center max-h-[90dvh] overflow-y-auto touch-scroll">
            ...
            <div className="mt-5 rounded-2xl bg-slate-50 border border-slate-200/80 p-3.5 sm:p-4 text-left space-y-2.5 text-xs">
      ...
      {/* Official Admission Form Modal */}
      {createdResult && admissionModalOpen && (
        <AdmissionFormModal
          open={admissionModalOpen}
          onClose={() => setAdmissionModalOpen(false)}
          student={createdResult}
        />
      )}
    </div>
  )
