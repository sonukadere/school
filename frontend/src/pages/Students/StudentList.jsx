...
function StudentList() {
  ...
  const canCreate = hasPermission('students.create') || hasPermission('students.manage')
  const canUpdate = hasPermission('students.update') || hasPermission('students.manage')
  const canDelete = hasPermission('students.delete') || hasPermission('students.manage')
