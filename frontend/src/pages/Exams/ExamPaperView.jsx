...
export default function ExamPaperView() {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'paper' && (
        <div className="mx-auto max-w-4xl rounded-xl border border-slate-200 bg-white p-8 shadow-xs print:m-0 print:max-w-none print:border-none print:p-0 print:shadow-none">
